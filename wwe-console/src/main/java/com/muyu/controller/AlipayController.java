...
public class AlipayController {
    ...
    public ModelAndView goConfirm(Long productId) throws Exception {
    ...
    public ModelAndView goPay(Long orderId) throws Exception {
    ...
    public ModelAndView alipayReturnNotice(HttpServletRequest request, HttpServletRequest response) throws Exception {
        ...
        if (signVerified) {
            ...
            orderService.updateOrderStatus(Long.valueOf(out_trade_no), trade_no, total_amount);


            Orders order = orderService.getOrderById(Long.valueOf(out_trade_no));
            Product product = productService.getProductById(order.getProductId());
